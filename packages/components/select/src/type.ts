...
export type SelectStates = {
  inputValue: string
  options: Map<OptionPublicInstance['value'], OptionPublicInstance>
  cachedOptions: Map<OptionPublicInstance['value'], OptionPublicInstance>
  optionValues: OptionPublicInstance['value'][]
  selected: OptionPublicInstance[]
